...
int main()
{
    ...
    Shader phongSpotLightShader("phong_spotlight.glsl");
...
//    phongSunShader.setTexture("material.emission", boxEmissionMap);
    ...
    phongSpotLightShader.setTexture("material.diffuse", boxTex);
    phongSpotLightShader.setTexture("material.specular", boxSpecularMap);
    ...
    while (running)
    {
        ...
        // Render
        {
            ...
            // Upload uniforms
            {
                ...
                //
                phongSpotLightShader.setMat4("vView", view);
                phongSpotLightShader.setMat4("vProjection", projection);
                phongSpotLightShader.setFloat3("fViewPos", fpsView.getPosition());
                phongSpotLightShader.setFloat("material.shininess", 64.f);
                phongSpotLightShader.setFloat3("light.pos", fpsView.getPosition());
                phongSpotLightShader.setFloat3("light.dir", fpsView.getFrontVector());
                phongSpotLightShader.setFloat("light.cutOff", glm::cos(glm::radians(spotlightCutoff))); // send cos() val for perf improve
                phongSpotLightShader.setFloat("light.outerCutoff", glm::cos(glm::radians(spotlightOuterCutoff)));
                phongSpotLightShader.setFloat3("light.ambient", ambient);
                phongSpotLightShader.setFloat3("light.diffuse", diffuse);
                phongSpotLightShader.setFloat3("light.specular", 1.0f, 1.0f, 1.0f);
                phongSpotLightShader.setFloat("light.constant", 1.f);
                phongSpotLightShader.setFloat("light.linear", 0.09f);
...
//                model = glm::rotate(model, glm::radians(0.0), glm::vec3(0.f, 1.f, 0.f));
            ...
            // boxes
            {
                ...
                for(int i = 0; i < 10; i++)
                {
                    ...
                    phongSpotLightShader.setMat4("vModel", model);
                    glDrawArrays(GL_TRIANGLES, 0, 36);
                }
                box.Unbind();
            }

...
int main()
{
    ...
    Shader phongDiffuseShader("phong_diffuse_map.glsl");
    Shader lightBulbShader("lightcube.glsl");
//    Shader textureShader("texCube.glsl");

    Texture2D boxTex("../../../assets/box.png");
//    textureShader.setTexture("tex", boxTex);
    ...
    while (running)
    {
        ...
        // Draw
        {
            ...
            phongDiffuseShader.setFloat3("material.specular", 0.5f, 0.5f, 0.5f);

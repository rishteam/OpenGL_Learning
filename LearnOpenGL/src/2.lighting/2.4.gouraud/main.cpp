...
int main()
{
    ...
    Shader gouraudShader("gouraud.glsl");
    gouraudShader.setFloat3("fObjectColor", 1.0f, 0.5f, 0.31f);
    ...
    while (running)
    {
        ...
        static glm::vec3 gouraudSpherePos(3.f, 0.f, -1.f);
        ...
        glm::mat4 model(1.f), view(1.f), projection(1.f);
        {
            ...
            ImGui::DragFloat3("gouraud sphere", glm::value_ptr(gouraudSpherePos));
        ...
        // Draw
        {
            ...
            phongShader.setFloat3("fLightPos", lightPos);
            ...
            //
            gouraudShader.setMat4("vView", view);
            gouraudShader.setMat4("vProjection", projection);
            gouraudShader.setFloat3("vLightColor", glm::vec3(lightColor));
            gouraudShader.setFloat("vAmbientStrength", ambientStrength);
            gouraudShader.setFloat3("vLightPos", lightPos);
            gouraudShader.setFloat3("vViewPos", fpsView.getPosition());
            gouraudShader.setFloat("vShininess", shininess);
            gouraudShader.setFloat("vSpecularStrength", specularStrength);
            //
